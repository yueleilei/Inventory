...
Wire Bus Line
	11750 4450 12200 4900
Wire Bus Line
	12200 4900 12200 5800
Wire Wire Line
	8500 5600 9000 5600
Wire Bus Line
	8400 4600 8400 8300
...
Wire Bus Line
	5900 4200 5900 4500
Wire Bus Line
	5900 4500 11900 4500
Wire Bus Line
	11900 4500 11900 1350
Wire Bus Line
	11750 1050 11750 4350
Wire Wire Line
	11850 1650 12450 1650
Wire Wire Line
	15400 6200 16250 6200
Wire Wire Line
...
Wire Wire Line
	16300 2700 15400 2700
Connection ~ 16300 1750
Wire Wire Line
	16300 1750 15400 1750
...
Wire Wire Line
	16300 2250 15400 2250
Connection ~ 16300 2250
Wire Wire Line
	16300 3200 15400 3200
Connection ~ 16300 3200
Wire Wire Line
	16300 4400 15400 4400
Connection ~ 16300 4400
Wire Wire Line
	8600 4750 16250 4750
...
Wire Bus Line
	6000 4050 6000 4350
Wire Bus Line
	6000 4350 11750 4350
Wire Wire Line
	11850 3600 12450 3600
Wire Wire Line
	11850 3100 12450 3100
Wire Wire Line
	11850 2600 12450 2600
Wire Wire Line
	11850 2150 12450 2150
Wire Wire Line
	11850 1150 12450 1150
Wire Wire Line
	11850 4300 12450 4300
Wire Wire Line
...
Entry Wire Line
	11900 2800 12000 2700
Entry Wire Line
	11900 3300 12000 3200
Entry Wire Line
	11900 3800 12000 3700
Entry Wire Line
	11900 4500 12000 4400
Entry Wire Line
	11900 1350 12000 1250
Entry Wire Line
...
Entry Wire Line
	11750 2500 11850 2600
Entry Wire Line
	11750 2050 11850 2150
Entry Wire Line
	11750 1550 11850 1650
Entry Wire Line
	11750 1050 11850 1150
$Comp
L CONN_2 P?
U 1 1 48910350
P 3500 750
...
F 1 "12V bat" V 3550 750 40  0000 C C
	...
	0    -1   -1   0   
$EndComp
Text Notes 11800 6000 0    60   ~
pg26
Text Notes 8750 5900 0    60   ~
pg7
$Sheet
...
pg23
Text Notes 11800 7350 0    60   ~
pg24
Text Notes 11800 6900 0    60   ~
pg25
...
pg9
Text Notes 8750 7250 0    60   ~
pg7
Text Notes 8750 6800 0    60   ~
pg7
Text Notes 8750 6350 0    60   ~
pg7
Text Notes 8750 5450 0    60   ~
pg7
Text Notes 2950 6750 0    60   ~
pg15
Text Notes 2950 6400 0    60   ~
pg15
Text Notes 2950 6050 0    60   ~
pg15
Text Notes 2950 5700 0    60   ~
pg15
Text Notes 2950 5350 0    60   ~
pg15
Text Notes 12150 4250 0    60   ~
pg21
Text Notes 2950 5000 0    60   ~
pg15
Text Notes 12150 3050 0    60   ~
pg21
Text Notes 12150 2550 0    60   ~
pg21
Text Notes 12150 2100 0    60   ~
pg21
Text Notes 12150 1600 0    60   ~
pg21
Text Notes 12150 1100 0    60   ~
pg21
Text Notes 11800 5100 0    60   ~
pg28
Text Notes 3700 1450 0    60   ~
pg29
Text Notes 800  1600 0    60   ~
pg30
$Sheet
...
U 1 1 486F7882
P 7400 7000
F 0 "#PWR?" H 7400 7000 30  0001 C C
F 1 "GND" H 7400 6930 30  0001 C C
	1    7400 7000
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 486F7315
P 3400 1950
F 0 "#PWR?" H 3400 1950 30  0001 C C
F 1 "GND" H 3400 1880 30  0001 C C
	1    3400 1950
	1    0    0    -1  
$EndComp
$Sheet
...
$EndSheet
$Sheet
S 3250 6750 4000 150 
F0 "igniter_6" 60
F1 "freeEMS_ignition.sch" 60
F2 "low_power_inductive_gnd" B R 7250 6800 60 
F3 "low_power_inductive_drive" I L 3250 6800 60 
$EndSheet
$Sheet
S 3250 6400 4000 150 
F0 "igniter_5" 60
F1 "freeEMS_ignition.sch" 60
F2 "low_power_inductive_gnd" B R 7250 6450 60 
F3 "low_power_inductive_drive" I L 3250 6450 60 
$EndSheet
$Sheet
S 3250 6050 4000 150 
F0 "igniter_4" 60
F1 "freeEMS_ignition.sch" 60
F2 "low_power_inductive_gnd" B R 7250 6100 60 
F3 "low_power_inductive_drive" I L 3250 6100 60 
$EndSheet
$Sheet
S 3250 5700 4000 150 
F0 "igniter_3" 60
F1 "freeEMS_ignition.sch" 60
F2 "low_power_inductive_gnd" B R 7250 5750 60 
F3 "low_power_inductive_drive" I L 3250 5750 60 
$EndSheet
$Sheet
S 3250 5350 4000 150 
F0 "igniter_2" 60
F1 "freeEMS_ignition.sch" 60
F2 "low_power_inductive_gnd" B R 7250 5400 60 
F3 "low_power_inductive_drive" I L 3250 5400 60 
$EndSheet
$Sheet
S 3250 5000 4000 150 
F0 "igniter_1" 60
F1 "freeEMS_ignition.sch" 60
F2 "low_power_inductive_gnd" B R 7250 5050 60 
F3 "low_power_inductive_drive" I L 3250 5050 60 
$EndSheet
$Sheet
...
$EndSheet
$Sheet
S 4050 1450 1450 3050
F0 "CPU" 60
F1 "freeEMS_CPU.sch" 60
F2 "AN15" B L 4050 4200 60 
F3 "AN14" B L 4050 4100 60 
F4 "AN13" B L 4050 4000 60 
F5 "AN12" B L 4050 3900 60 
F6 "PM0" B L 4050 3800 60 
F7 "PM1" B L 4050 3700 60 
F8 "PM2" B L 4050 3600 60 
F9 "PM3" B L 4050 3500 60 
F10 "PM4" B L 4050 3400 60 
F11 "PM5" B L 4050 3300 60 
F12 "PM6" B L 4050 3200 60 
F13 "PM7" B L 4050 3100 60 
F14 "PJ6" B L 4050 3000 60 
F15 "PJ7" B L 4050 2900 60 
F16 "PJ0" B L 4050 2800 60 
F17 "PK0" B L 4050 2700 60 
F18 "PK1" B L 4050 2600 60 
F19 "PK2" B L 4050 2500 60 
F20 "PK3" B L 4050 2400 60 
F21 "PK4" B L 4050 2300 60 
F22 "PK5" B L 4050 2200 60 
F23 "PK7" B L 4050 2100 60 
F24 "PE7" B L 4050 2000 60 
F25 "GND" B L 4050 1900 60 
F26 "VCC" B L 4050 1800 60 
F27 "AN11" B R 5500 4200 60 
F28 "AN10" B R 5500 4100 60 
F29 "AN09" B R 5500 4000 60 
F30 "AN08" B R 5500 3900 60 
F31 "PJ1" B R 5500 3800 60 
F32 "IRQ" B R 5500 3700 60 
F33 "LSTRB" B R 5500 3600 60 
F34 "ECLK" B R 5500 3500 60 
F35 "R/W" B R 5500 3400 60 
F36 "PB0" B R 5500 3300 60 
F37 "PB1" B R 5500 3200 60 
F38 "PB2" B R 5500 3100 60 
F39 "PB3" B R 5500 3000 60 
F40 "PB4" B R 5500 2900 60 
F41 "PB5" B R 5500 2800 60 
F42 "PB6" B R 5500 2700 60 
F43 "PB7" B R 5500 2600 60 
F44 "PA0" B R 5500 2500 60 
F45 "PA1" B R 5500 2400 60 
F46 "PA2" B R 5500 2300 60 
F47 "PA3" B R 5500 2200 60 
F48 "PA4" B R 5500 2100 60 
F49 "PA5" B R 5500 2000 60 
F50 "PA6" B R 5500 1900 60 
F51 "PA7" B R 5500 1800 60 
$EndSheet
$Sheet
S 1150 1600 2050 400 
F0 "power regulator" 60
F1 "freeEMS_power_reg.sch" 60
F2 "5v reg" I R 3200 1800 60 
F3 "12v batt" O R 3200 1700 60 
F4 "gnd" B R 3200 1900 60 
$EndSheet
$EndSCHEMATC
